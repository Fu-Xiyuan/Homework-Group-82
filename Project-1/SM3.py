...
def gen_random_string(byte):
    random_string = ''.join(random.choices(string.ascii_letters + string.digits, k=byte))
    return random_string


def test():
    data_size = [1024 * 1024, 1024 * 1024 * 32, 1024 * 1024 * 64, 1024 * 1024 * 128, 1024 * 1024 * 128]
    for j in range(5):
        ...
        print("加密 {} 数据 10 次总用时为 :{} 秒".format(data_size[j], use_time))
        print("加密 {} 数据 1 次平均用时为 :{} 秒".format(data_size[j], use_time / 10))
